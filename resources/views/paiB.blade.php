...
<form method="POST" action="/paymentVirement/{{$ins->id}}" enctype="multipart/form-data">
  @csrf
      ...
      <div class="col-6">
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="file" class="file-input" id="fileInput2"  name="recu" style="display: none" required>
