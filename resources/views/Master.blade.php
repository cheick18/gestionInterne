...
<nav class="navbar navbar-expand-lg navbar-light ">
    ...
    <h3 class="text-danger">Inscrire un etudiant en master </h3>

    <!--

    <a href="https://api.whatsapp.com/send?phone=0614036218" target="_blank">Envoyer un message WhatsApp</a>
    -->
    <form class="mb-3" id="myForm" method="post" action="/add_master/{{Auth::user()->id}}" enctype="multipart/form-data">
        @csrf
     <div class="row" >
      ...
      <div class="col-8 col-xs-12">
        ...
        <div class="col-2">
          ...
          <input type="file" class="file-input" id="fileInput1" style="display: none" name="photo" required>
          ...
          <div class="col-2">
            ...
            <input type="file" class="file-input" id="fileInput2" style="display: none" name="cin" required>
          ...
          <div class="col-2">
            <span class="text-secondary">Licence</span>
            <input type="file" class="file-input" id="fileInput4" style="display: none" name="lp" required>
          ...
          <div class="col-2">
            <span class="text-secondary">Attestation</span>
            <input type="file" class="file-input" id="fileInput5" style="display: none" name="attestation" required>
