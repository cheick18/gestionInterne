...
<form method="POST" action="/pos" enctype="multipart/form-data">
  @csrf
<nav class="mb-4">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"> <a href="/autrepay" class="block text-decoration-none text-dark">Completer paiement</a></button>
