     ...
     <div class="row" >
      ...
      <div class="col-8 col-xs-12">
        ...
        <div class="col-2">
          ...
          <input type="file" class="file-input" id="fileInput1" style="display: none" name="stage" required>
          ...
          <div class="col-2">
            <span class="text-secondary">Convention</span>
            <input type="file" class="file-input" id="fileInput2"  name="convention" style="display: none" required>
          ...
          <div class="col-2">
            <span class="text-secondary">Assurance</span>
            <input type="file" class="file-input" id="fileInput3" name="assurance" style="display: none" required>
